...
It is the TypeScript-native answer to Python-centric evaluation stacks, inspired by [arXiv:2608.12307 — _AI4AI at Test-Time: Strong-to-Weak Capability Transfer via Harnesses_](https://arxiv.org/abs/2608.12307) and the reversible-effect micro-kernel of [Cordis](https://github.com/cordiverse/cordis).
